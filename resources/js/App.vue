  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <router-link to="/" class="menu-link">
                ...
                <div> ສະຕ໋ອກສີນຄ້າ</div>
      </router-link>
   </li>
 
    <li class="menu-item ">
      <router-link to="/pos" class="menu-link menu-toggle">
    ...
    <li class="menu-item ">
      <router-link to="/transection" class="menu-link menu-toggle">
    ...
    <li class="menu-item ">
      <router-link to="/report" class="menu-link menu-toggle">
